        ...
        <div class="w-full min-h-screen flex items-center justify-center bg-black">
            <div class="md:w-2/3 w-full px-4 text-white flex flex-col">
                <div class="w-full text-7xl font-bold">
                    <h1 class="w-full md:w-2/3">How can i help you. get
                        in touch</h1>
                </div>
                <div class="flex mt-8 flex-col md:flex-row md:justify-between">
                    ...
                    <div class="w-44 pt-6 md:pt-0">
                         <a href='mailto:ekemasamuel954@gmail.com' class="bg-red-500 justify-center text-center rounded-lg shadow px-10 py-3 flex items-center">Contact ME</a>
                     </div>
                    </div>
                    <div class="flex flex-col">
                        ...
                        <p class="w-full text-center my-12 text-gray-600">Copyright © 2024 Samuel Creative</p>
                    </div>
                </div>
            </div>
    </div>
